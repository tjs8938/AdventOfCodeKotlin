...
data class User(val email: String, val token: String) {
    companion object {
        fun allUsers() : List<User> {
            return listOf(
//                User("tjs8938@gmail.com", "53616c7465645f5f1f4164239b4d10e293645aea516c7c040264390f2c0fedd773b15a1238af8110e679efde20f34d9e6cd16ff553a1abf6a4aaed6c10907366"),
